...
class Point0:
    ...
    @property
    def y(self):
        return int.from_bytes(self.bs[4:8], 'little')

    @property
    def z(self):
        return int.from_bytes(self.bs[8:12], 'little')
...
class Point4:
    ...
    @property
    def z1(self):
        return int.from_bytes(self.bs[:12], 'little')
    ...
    @property
    def x2(self):
        return int.from_bytes(self.bs[:18], 'little')

    @property
    def y2(self):
        return int.from_bytes(self.bs[:22], 'little')

    @property
    def z2(self):
        return int.from_bytes(self.bs[:26], 'little')
...
class Point5:
    ...
    @property
    def depth2(self):
        return int.from_bytes(self.bs[10:14], 'little')
